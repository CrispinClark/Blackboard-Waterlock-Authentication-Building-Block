 ...
 * THIS CLASS IS A COPY of the JWTVerifier class from com.auth0.jwt, with the verify method edited to disallow override of access modifiers.
 */
public class EditedJWTVerifier {
    ...
    public EditedJWTVerifier(String secret, String audience, String issuer) {
        this(secret.getBytes(Charset.forName("UTF-8")), audience, issuer);
    }

    public EditedJWTVerifier(String secret, String audience) {
        this(secret, audience, null);
    }

    public EditedJWTVerifier(String secret) {
        this(secret, null, null);
    }

    public EditedJWTVerifier(byte[] secret, String audience, String issuer) {
    ...
    public EditedJWTVerifier(byte[] secret, String audience) {
        this(secret, audience, null);
    }

    public EditedJWTVerifier(byte[] secret) {
        this(secret, null, null);
    }
    ...
    JsonNode decodeAndParse(String b64String) throws IOException {
        String jsonString = new String((byte[]) decoder.decode(b64String), "UTF-8");
